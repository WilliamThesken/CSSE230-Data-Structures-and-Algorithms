...
public class ShapeTest {
	...
	public void testSortTrianglesByAreaUsingTreeSet() {
		...
		TreeSet<Triangle> triangleSet = new TreeSet(byArea);

		// TODO: 2 Iterate through the unsorted triangles array, adding the
		// triangles
		// to the TreeSet.
		for(Triangle arrayTriangle: triangles)
		{
			triangleSet.add(arrayTriangle);
		}
		...
		for(Triangle treeSetTriangle: triangleSet)
		{
			System.out.println(treeSetTriangle);
		}
